...
class LossSelf(nn.Module):
    ...
    def forward(self,pose_imgs,depth_imgs,depth_map,K,
        ...
        res_t_stereo = residual_loss(pose_imgs["t"],warped_img3,alpha)
        ...
        #batch_chkpt = [0,500,1000,1500,2000]
...
class TotalLoss(nn.Module):
    ...
    #@staticmethod
    def forward(self,pose_imgs,depth_imgs,scales,stereo_baseline,K,pose_6dof_t_minus_1_t,pose_6dof_t_t_plus_1,a,b,beta,batch_num,dataset_type):
